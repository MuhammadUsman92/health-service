...
public class ReportServiceImpl implements ReportService {
    ...
    @Override
    public ReportDto createReport(ReportDto reportDto, Integer laboratoryId) {
    ...
    @Override
    public ReportDto createReport(Integer prescriptionId, Integer laboratoryId, ReportDto reportDto) {
        Report report = conversionDtos.reportDtoToReport(reportDto);
