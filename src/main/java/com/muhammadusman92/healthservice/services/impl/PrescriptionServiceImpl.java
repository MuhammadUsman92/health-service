...
public class PrescriptionServiceImpl implements PrescriptionService {
    ...
    @Override
    public PrescriptionDto createPrescription(PrescriptionDto prescriptionDto, Integer diseaseId, Integer doctorId, Integer hospitalId) {
        Prescription prescription = conversionDtos.prescriptionDtoToPrescription(prescriptionDto);
        ...
        disease.getPatient().getHospitalSet().add(hospital);
        disease.getPatient().getDoctorSet().add(doctor);
        patientRepo.save(disease.getPatient());
        hospital.getPatients().add(disease.getPatient());
    ...
    private PrescriptionDto prescriptionData(Prescription prescription,PrescriptionDto prescriptionDto){
        ...
        prescriptionDto.setDoctorDto(conversionDtos.doctorToDoctorDto(prescription.getDoctor()));
        prescriptionDto.setHospitalDto(conversionDtos.hospitalToHospitalDto(prescription.getHospital()));
        ...
        prescriptionDto.setMedicineDtoSet(medicineDtos);
